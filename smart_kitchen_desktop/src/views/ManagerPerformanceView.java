...
public class ManagerPerformanceView extends JFrame {

    public ManagerPerformanceView() {
        initComponents();
    }

    private void initComponents() {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setTitle("Smart Kitchen - Manager Performance");

        JLabel lbl = new JLabel("Manager Performance - TODO", SwingConstants.CENTER);
