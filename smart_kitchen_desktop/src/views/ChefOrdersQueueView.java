...
public class ChefOrdersQueueView extends JFrame {

    public ChefOrdersQueueView() {
        initComponents();
    }

    private void initComponents() {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setTitle("Smart Kitchen - Orders Queue");

        JLabel lbl = new JLabel("Orders Queue - TODO", SwingConstants.CENTER);
