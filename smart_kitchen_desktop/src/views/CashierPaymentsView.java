...
public class CashierPaymentsView extends JFrame {

    public CashierPaymentsView() {
        initComponents();
    }

    private void initComponents() {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setTitle("Smart Kitchen - Payments");

        JLabel lbl = new JLabel("Payments - TODO", SwingConstants.CENTER);
